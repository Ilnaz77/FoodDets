...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        if ckpt["optimizer"] is not None:
            print('Optimizer dict correct ...')
            optimizer.load_state_dict(ckpt["optimizer"])
            # print('Optimizer dict: ', optimizer.state_dict())
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(test_path, imgsz_test, batch_size, gs, opt, hyp=hyp, augment=False, cache=opt.cache_images, rect=True, local_rank=-1, world_size=opt.world_size)[0]
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            # Tensorboard
            if tb_writer:
                tags = ["train/giou_loss", "train/obj_loss", "train/cls_loss", "metrics/precision", "metrics/recall", "metrics/mAP_0.5", "metrics/mAP_0.5:0.95", "val/giou_loss", "val/obj_loss", "val/cls_loss"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights", type=str, default="runs/exp3/weights/last_023.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="cfg/yolov4.cfg", help="model.yaml path")
    parser.add_argument("--data", type=str, default="cfg/custom.yaml", help="data.yaml path")
    ...
    parser.add_argument("--resume", nargs="?", const="get_last", default='', help="resume from given path/last.pt, or most recent run if blank")
